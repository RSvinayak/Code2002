     ...
     function  checkSort3() {
           ...
           // console.log("checkSort3 ");
            ...
            function logSetElements(value1) {
                 //  console.log(value1);
           if(value1.item == report1[k].item && value1.group  == report1[k].group && value1.salesCtg== report1[k].salesCtg  && value1.purity == report1[k].purity){
          //  console.log("value1");
                sort3Check = true;
               }else{
                     sort3Check = false;
